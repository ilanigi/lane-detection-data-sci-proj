...
from src.Utils.Regressions import get_point_from_RANSAC
...
def main():
    ...
    new_left_rec = get_rectangle_from_mid_bottom(point, rectangle_width, rectangle_height)

    point = get_point_from_RANSAC(img, right_rec)
    new_right_rec = get_rectangle_from_mid_bottom(point, rectangle_width, rectangle_height)
